...
<body>
	...
	<div class="last_button">
		...
		<div class="wrap_last_b">
			...
			<button><img id="aad_loading" style="display:none;width:20px;margin: -5px 81px 0 -24px;" src="<?php echo site_url(); ?>/aad_dir/img/loader.gif" /><span id="aad_before_loading">DONE <img src="<?php echo site_url(); ?>/aad_dir/img/right_arr.png" alt="right_arr"></span></button>
